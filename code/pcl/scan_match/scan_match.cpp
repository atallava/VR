...
void VizMatches(pcl::PointCloud<pcl::PointXYZ>::ConstPtr cloud_target, pcl::PointCloud<pcl::PointXYZ>::ConstPtr cloud_src, pcl::PointCloud<pcl::PointXYZ>::ConstPtr cloud_match)
{
...
int main(int argc, char** argv)
{
    ...
    else if(pcl::console::find_argument(argc, argv, "-f") >= 0)
	{
		...
		std::string scan_name = dir + "/scan_" + boost::to_string(i+1) + ".pcd";
