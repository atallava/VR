...
situationNames = {'situation_l_map_1','situation_l_map_2','situation_l_map_3','situation_l_map_4',...
    ...
    'situation_b_corridor_clear','situation_b_corridor_clutter',...
    'situation_nsh3_corridor_clear','situation_nsh3_corridor_clutter'};
nSituations = length(situationNames);

elementsPerSituation = [20 20 20 20,...
    0,...
    0 0,...
    0 0];
