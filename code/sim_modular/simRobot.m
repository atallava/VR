...
% 		delV = 0.1; delW = 0.02;
		delV = 0; delW = 0;
		% errors in encoder readings
% 		delVl = 0.0138; delVr = 0.0225;
		delVl = 0; delVr = 0;
    end
    ...
    methods(Access = private)
        ...
        % the active commanded velocities.    
			...
			dl = obj.vl*dt*1000.0;
            dr = obj.vr*dt*1000.0;
			% inject noise into encoders
% 			[dl,dr] = obj.addErrorToEncoders(dl,dr);
        ...
        function [l,r] = addErrorToEncoders(obj,l,r)
			l = l./(1+obj.delVl);
			r = r./(1+obj.delVr);
		end
        ...
        % the command FIFO.
            ...
            obj.V = (vrd+vld)/2.0;
			obj.w = (vrd-vld)/obj.W;
			% inject error into commanded velocities
			[obj.V,obj.w] = obj.addErrorToCommandedVelocity(obj.V,obj.w);
		end
		
		function[V,w] = addErrorToCommandedVelocity(obj,V,w)
			V = V+obj.delV*V;
			w = w+obj.delW;
		end
