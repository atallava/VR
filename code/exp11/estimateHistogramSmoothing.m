function [h,hCenters] = estimateHistogramSmoothing(XTrain,ZTrain,X,laser,bwX,bwZ)
%ESTIMATEHISTOGRAMSMOOTHING Second-stage regressor is locally weighted
% linear regression.
%
% [h,hCenters] = ESTIMATEHISTOGRAMSMOOTHING(XTrain,ZTrain,X,laser,bwX,bwZ)
%
...
p = dRegressSmoothing(XTrain,ZTrain,iCenters,X,bwX,bwZ);
